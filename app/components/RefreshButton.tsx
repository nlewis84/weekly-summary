...
export function RefreshButton({ onClick, isLoading }: RefreshButtonProps) {
  ...
  return (
    <button
      ...
      className={`focus-inset-ring flex items-center justify-center gap-2 min-h-[44px] min-w-[44px] px-3 py-2 text-sm text-primary-500 rounded-lg transition-colors ${
        displaying
