...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      title={label}
      className="min-h-[44px] min-w-[44px] flex items-center justify-center p-2 text-[var(--color-text-muted)] hover:text-primary-500 hover:bg-[var(--color-surface-elevated)] rounded-lg transition-colors -m-1 sm:m-0 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 focus:ring-offset-[var(--color-surface)]"
    >
      {theme === "dark" ? (
