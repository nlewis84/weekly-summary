...
export function FullSummaryForm({
  ...
  return (
    <details
      ...
      className="w-full bg-surface rounded-xl shadow-(--shadow-skeuo-card) hover:shadow-(--shadow-skeuo-card-hover) border border-(--color-border) transition-all duration-300 xl:min-h-0 xl:flex xl:flex-col"
    >
